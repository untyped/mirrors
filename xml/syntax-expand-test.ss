  ...
  (test-suite "syntax-expand.ss"
    ...
    (test-case "xml*: elements"
      ...
      (check-equal? (xml* (a (@ ,(make-attribute 'href url) [class ,text]) ,text)) 
                    (make-element 'a (list (make-attribute 'href url) (make-attribute 'class text)) (make-atom text))
                    "unquote in attributes and children")
      (check-equal? (xml* (a (@ ,@(list (make-attribute 'href url) (make-attribute 'class "blue")))
                            ,@(list text text)))
                    (make-element 'a 
                                  (list (make-attribute 'href url) (make-attribute 'class "blue"))
